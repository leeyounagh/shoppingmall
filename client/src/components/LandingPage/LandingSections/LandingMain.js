    ...
    const Images = () =>{
        return(
         ...
         position:'relative',top:'480px',left:'570px',zIndex:'5'}}></img>
          <span className='Landing_Title title_fade' id='main_title' style={{left:'720px',zIndex:'30',display:'flex',position:'absolute',justifyContent:'center',
           top:'150px'}}>
              
          Vint</span>
            
          <div className='Landing_Title title_fade1' id='main_title' style={{display:'flex',justifyContent:'center',position:'absolute',left:'760px',
            top:'190px'}}>Age</div>
